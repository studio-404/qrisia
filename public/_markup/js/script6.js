...
/*! formstone v0.7.18 [mediaquery.js] 2015-08-30 | MIT License | formstone.it */
...
/*! formstone v0.7.18 [tooltip.js] 2015-08-30 | MIT License | formstone.it */
...
(function ($) {
  			...
  			'enter': function () {
  				if (!$("body").hasClass("section-starthere")) {
  					...
  					$("nav li.expanded").each(function (c) {
  						...
  						if (count > 4) {
  							var third = count / 3;
  							$(this).find('ul.menu > li').slice(0, third + 1).addClass('col1');
  							$(this).find('ul.menu > li').slice(third + 1, third + third +1).addClass('col2');
  							$(this).find('ul.menu > li').slice(third + third + 1, count).addClass('col3');
  						}

  					});

  					$('ul.menu li.expanded ul.menu').wrap('<div class="dropdown-menu-content"></div>');
  					$('.dropdown-menu-content').wrap('<div class="dropdown-menu"></div>');


  					$(".submenu-0 ul .col1").wrapAll("<div class='submenu-col' ></div>");
  					$(".submenu-0 ul .col2").wrapAll("<div class='submenu-col' ></div>");
  					$(".submenu-0 ul .col3").wrapAll("<div class='submenu-col' ></div>");
  					$(".submenu-1 ul .col1").wrapAll("<div class='submenu-col' ></div>");
  					$(".submenu-1 ul .col2").wrapAll("<div class='submenu-col' ></div>");
  					$(".submenu-1 ul .col3").wrapAll("<div class='submenu-col' ></div>");
  					$(".submenu-2 ul .col1").wrapAll("<div class='submenu-col' ></div>");
  					$(".submenu-2 ul .col2").wrapAll("<div class='submenu-col' ></div>");
  					$(".submenu-2 ul .col3").wrapAll("<div class='submenu-col' ></div>");
  				} 
  				}
  		});
  	}
  ...
  Drupal.behaviors.positionSwiperArrows = {
    attach: function (context, settings) {
	  ...
	  var slideCount = $( '#block-views-home-page-views-homepage-hero .views-row-even' ).length;
	  //alert(slideCount);
		
	  $("#block-views-home-page-views-homepage-hero .view-content").wrapInner("<div class='swiper-container'></div>");
      ...
      $('.btn-menu-mobile', context).once('mobileMenu', function () {
        ...
        function init(){
          ...
          $mainMenu = $('#block-system-main-menu > ul.menu')
                      .clone()
                      .wrap('<div class="mobile-menu-navigation-wrapper" id="mobile-menu-navigation-wrapper"></div>')
                      .parent();
          $audienceMenu = $('#block-menu-menu-audiences ul.menu')
                        .clone()
                        .wrap('<div class="mobile-menu-audiences-wrapper" id="mobile-menu-audiences-wrapper"></div>')
                        .parent();
          $audienceHeader = $('<h3>INFO FOR</h3>');
          $toolbarHeader = $('<h3>HOO LINKS</h3>');
          $toolbarMenu = $('#menu-toolbar-header ul')
                        .clone()
                        .wrap('<div class="mobile-menu-toolbar-wrapper" id="mobile-menu-toolbar-wrapper"></div>')
                        .parent();
          $btnMobileMenu = $('.btn-menu-mobile');
			
		  $give = $('div.view-header-give')
                        .clone();
          ...
          $navItem = $('.mobile-menu-navigation-wrapper > .menu > .expanded > a');
          $navItem.prepend('<span class="dd-arrow"></span>');

          $navItemArrow = $('.mobile-menu-navigation-wrapper > .menu > .expanded > a .dd-arrow');
        ...
        function toggleMobileMenu() {
          ...
          if(!$('html').hasClass('mobile-menu-is-open')){
            ...
            $('#mobile-menu-wrapper')
            .css({'height': $(window).outerHeight() - $('header .row-branding').outerHeight()})
            .scrollTop(0);
          } else {
            $('html, body').removeClass('mobile-menu-is-open');
